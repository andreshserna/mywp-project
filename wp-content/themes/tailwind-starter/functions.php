...
function tailwind_starter_setup() {
	/*
		...
		* If you're building a theme based on Tailwind Starter, use a find and replace
		* to change 'tailwind-starter' to the name of your theme in all the template files.
		*/
 ...
 */
function tailwind_starter_scripts() {
	wp_enqueue_style( 'tailwind-starter-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'tailwind-starter-style', 'rtl', 'replace' );
...
add_action( 'wp_enqueue_scripts', 'tailwind_starter_scripts' );
...
function tailwind_starter_enqueue_tailwind() {
    wp_enqueue_style(
        'tailwind-compiled',
        get_stylesheet_directory_uri() . '/assets/css/dist.css',
        array(),
        '1.0'
    );
}
add_action('wp_enqueue_scripts', 'tailwind_starter_enqueue_tailwind');


  function theme_enqueue_scripts() {
    wp_enqueue_style('tailwind', get_stylesheet_directory_uri() . '/assets/css/dist.css', [], '1.0.0');
}
